...
const Footer = () => {
  return (
    <footer className=" p-10  bg-slate-400">
      <div>
        <div>
          <span className="footer-title text-white">Connect with us for update and offers.</span>
     ...
     <div className='footer'>
      ...
      <div>
       ...
       <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> Nullam interdum leo at finibus ornare. Aliquam gravida <br /> condimentum neque, vel ultrices purus dignissim a.</p>
      </div>
      <div>
    ...
    <div className="grid grid-flow-col gap-4 ">
      ...
      <div>
    <p className='text-center mt-5'>Copyright © 2023 - All right reserved by <span className='bg-yellow-500 p-1 rounded-lg'>BongDine</span></p>
  </div>
    </footer>
  );
};
